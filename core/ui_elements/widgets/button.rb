...
class Button < UIElement
    ...
    def build
        ...
        unless @background_image.nil?
            image = Image.new(@root, __dir__+"/../../assets/#{@background_image}", cover: @background_image_cover){Rectangle2.new(@rectangle.x+1, @rectangle.y+1, @rectangle.width-2, @rectangle.height-2)}
